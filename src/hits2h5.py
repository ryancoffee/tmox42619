...
def main():
        ...
        ############################################
    scratchdir = '/reg/data/ana16/tmo/tmox42619/scratch/christos/h5files'
    ...
    for r in range(len(runnums)):
        for key in chans.keys():
            port[r][key] = Port(key,chans[key],logicthresh=logicthresh[key],inflate=inflate,expand=nr_expand,nrolloff=2**6)
